 ...
 */
class Galerie extends \Pnpc\Bundle\ScopsBundle\Entity\Galerie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nom', 'auteur', 'path', 'commentaire', 'file');
        }
