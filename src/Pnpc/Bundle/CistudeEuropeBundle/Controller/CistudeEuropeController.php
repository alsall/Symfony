...
use Pnpc\Bundle\CistudeEuropeBundle\Entity\Infos;
use Pnpc\Bundle\ScopsBundle\Entity\Documents;
use Pnpc\Bundle\ScopsBundle\Entity\Galerie;

use Pnpc\Bundle\CistudeEuropeBundle\Form\InfosType;
...
class CistudeEuropeController extends Controller
{
	
      public function indexAction()
    {
    	$shortname = "CistudeEurope";
        return $this->render('Pnpc'.$shortname.'Bundle:CistudeEurope:index.html.twig');
    }
